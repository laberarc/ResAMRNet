...
class Trainer:
    def __init__(self, args):
        ...
        from networks.mrnet import ResAMRNet
        self.model = ResAMRNet(use_meta=self.use_meta, dropout=args.dropout, force_bias=args.force_bias,
    ...
    def main(self):
        ...
        while True:
            ...
            if val_acc > best_val_acc:
                ...
                # Run test
                _, test_acc, test_acc_regime = self.test(epoch)

                if test_acc > best_test_acc:
                    best_test_acc = test_acc
                best_val_test_acc = max(best_val_acc,best_test_acc)
