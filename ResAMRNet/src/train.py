...
parser.add_argument('--dataset', type=str, default='I-RAVEN')#RAVEN
...
parser.add_argument('--w_loss', dest='weighted_loss', action='store_true',default=True)
parser.add_argument('--flip', dest='flip', action='store_true')#行列互换
...
parser.add_argument('--multihead', action='store_true',default=True)
parser.add_argument('--multihead_mode', type=str,default='eprob')
